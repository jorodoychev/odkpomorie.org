...
?>
    <main>
        <section id="news">
            <h3 class="px-2">За цветовете - основни цветове</h3>
            <p class="post-date px-2">Публикувано 24 ноември 2020г. в <a href="news.php">Изобразително изкуство</a></p>
            <iframe class="border-0 container-fluid" src="https://www.youtube.com/embed/QgwAH2ouwG8"
